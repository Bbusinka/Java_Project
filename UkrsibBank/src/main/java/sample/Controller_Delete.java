...
public class Controller_Delete {
    ...
    @FXML
    void initialize() {
        //Підтвердження даних для видалення облікового запису користувача
    ...
    public void MyOutput (HashMap<String,Object>hashMap,String name_file){
        //--------------------------------------------
        // зберігаємо дані в файл save.ser
    ...
    public HashMap<String,Object> MyInput() {// повертаємо колекцію для порівняння
