...
public class PopolnenieController {
...
//повернення на головне вікно системи
        back.setOnAction(event -> {
            ...
            stage.show(); });
//підтвердження поповнения рахунку мобільного телефону
            contin.setOnAction(event -> {if (!suma.getText().isEmpty() && !phone.getText().isEmpty()){

                double a=user1.getSumm();
                double c=Integer.parseInt(suma.getText())*0.02;
...
//----------------------------------
    ...
    public void MyOutput (HashMap<String,Object> hash, String name_file){
        ...
        //закрываєм поток и освобождаем ресурсы
        try {
